...
ARCHIVO = 'resultados_tenis_v67.json'
MIN_VENTANA = 300
...
def wf_circuito(circuito: str) -> dict:
    ...
    res = {k: [] for k in ('base', 'datos', 'nivel', 'mercado', 'nuevas')}
    ...
    ganador = 'nivel' if veredicto['nivel'] else ('datos' if veredicto['datos'] else 'base')
